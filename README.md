...
- [Key Value Spin Application](./kv/) - showcases the variety of key value store operations that can be performed from a Spin application using the Spin KV interface.
- [WASI Key Value Application](./wasi-kv/) - showcases all WASI KV atomic, batch, and store operations that can performed from a Spin application
